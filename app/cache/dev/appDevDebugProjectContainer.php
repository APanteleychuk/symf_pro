...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.part' => 'getSonata_Admin_PartService',
            ...
            'sonata.admin.season' => 'getSonata_Admin_SeasonService',
            'sonata.admin.security.handler' => 'getSonata_Admin_Security_HandlerService',
            'sonata.admin.serial' => 'getSonata_Admin_SerialService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e10456ab4208f4e10bea8993be1d276a9d7bd4a8561a8156daa1b0d8b0edb231');
    ...
    /**
     * Gets the 'sonata.admin.part' service.
     *
     * @return \Acme\DemoBundle\Admin\PartAdmin A Acme\DemoBundle\Admin\PartAdmin instance.
     */
    protected function getSonata_Admin_PartService()
    {
        $instance = new \Acme\DemoBundle\Admin\PartAdmin('sonata.admin.part', 'Acme\\DemoBundle\\Entity\\Part', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.serial', 1 => 'sonata.admin.season', 2 => 'sonata.admin.part'));
        $instance->setAdminGroups(array('Serials' => array('label' => 'Serials', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.serial', 1 => 'sonata.admin.season', 2 => 'sonata.admin.part'))));
        $instance->setAdminClasses(array('Acme\\DemoBundle\\Entity\\Serial' => array(0 => 'sonata.admin.serial'), 'Acme\\DemoBundle\\Entity\\Season' => array(0 => 'sonata.admin.season'), 'Acme\\DemoBundle\\Entity\\Part' => array(0 => 'sonata.admin.part')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.serial', 1 => 'sonata.admin.season', 2 => 'sonata.admin.part'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.season' service.
     *
     * @return \Acme\DemoBundle\Admin\SeasonAdmin A Acme\DemoBundle\Admin\SeasonAdmin instance.
     */
    protected function getSonata_Admin_SeasonService()
    {
        $instance = new \Acme\DemoBundle\Admin\SeasonAdmin('sonata.admin.season', 'Acme\\DemoBundle\\Entity\\Season', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.serial' service.
     *
     * @return \Acme\DemoBundle\Admin\SerialAdmin A Acme\DemoBundle\Admin\SerialAdmin instance.
     */
    protected function getSonata_Admin_SerialService()
    {
        $instance = new \Acme\DemoBundle\Admin\SerialAdmin('sonata.admin.serial', 'Acme\\DemoBundle\\Entity\\Serial', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d981b455b9972e1c522da70e310df0652dc84065');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('560e98749b5755.80952626')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'd981b455b9972e1c522da70e310df0652dc84065',
            'locale' => 'en',
            ...
            'kernel.secret' => 'd981b455b9972e1c522da70e310df0652dc84065',
